...
?>
 <li class="clearfix">
   <a class="image" href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail()) { echo the_post_thumbnail('widget_size2'); } else { echo '<img src="'; bloginfo('template_url'); echo '/images/no_image4.jpg" alt="" title="" />'; }; ?></a>
   <?php if( $show_date == '1' ) { ?>
